...
function Player:SetBankerUser(viewID)
    local imagedizhu="errenland/dizhu.png"
    local imagenongmin="errenland/nongmin.png"
...
function Player:SetUserOper(viewid,type)
    ...
    local image
    if type==1 then --不出
        image="errenland/buchu.png"
    end
    if type==2 then --叫地主
        image="errenland/Call.png"
    end
    if type==3 then --不叫
        image="errenland/NoCall.png"
    end
    if type==4 then --抢地主
        image="errenland/Qiang.png"
    end
    if type==5 then --不抢
        image="errenland/NoQiang.png"
    end
