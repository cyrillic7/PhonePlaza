OxTwoDefine=
    {
        ...
        SUB_S_ADD_SCORE_MY    =1009,  --其他人加注

        GAME_SCENCE                 = "OXTWO_SCENEME",             -- 场景的消息
        GAME_START                  = "OXTWO_STARTME",             -- 游戏开始
        GAME_ADD_SCORE         		= "OXTWO_ADD_SCORE",              -- 加注结果
        GAME_PLAYER_EXIT            = "OXTWO_PLAYER_EXIT",              -- 玩家退出
        GAME_SEND_CARD           = "OXTWO_SEND_CARD",         -- 发牌消息
        GAME_CALL_BANKER          = "OXTWO_CALL_BANKER",         -- 用户叫庄
        GAME_BASE   				 = "OXTWO_BASE",         -- 发送基数
        GAME_ALL_CARD			 = "OXTWO_ALL_CARD",         -- 用户换牌
        GAME_CHANGE_OPEN     		 = "OXTWO_CHANGE_OPEN",         -- 开牌
        GAME_OPEN_CARD              = "OXTWO_OPEN_CARD", --
        GAME_OVER 					= "OXTWO_GAMEOVER",	 -- 结束
        GAME_PLAYER_OPEN                  = "OXTWO_PLAYER_OPEN ",   --所有玩家卡牌数据
