OxqkbnewDefine=
    {
        ...
        SUB_S_USER_OPENCARD               =108,                                 --开牌
        SUB_S_USER_OPEN                 =109,                                 --所有用户开完牌


        GAME_SCENCE                 = "OXQKBNEW_SCENEME",             -- 场景的消息
        GAME_START                  = "OXQKBNEW_STARTME",             -- 游戏开始
        GAME_ADD_SCORE         		= "OXQKBNEW_ADD_SCORE",              -- 加注结果
        GAME_PLAYER_EXIT            = "OXQKBNEW_PLAYER_EXIT",              -- 玩家退出
        GAME_SEND_CARD           = "OXQKBNEW_SEND_CARD",         -- 发牌消息
        GAME_CALL_BANKER          = "OXQKBNEW_CALL_BANKER",         -- 用户叫庄
        GAME_BASE   				 = "OXQKBNEW_BASE",         -- 发送基数 
        GAME_USER_OPEN_CAED     		 = "OXQKBNEW_USER_OPEN_CAED",         -- 开牌
        GAME_OPEN_CARD              = "OXQKBNEW_OPEN_CARD", --
        GAME_OVER 					= "OXQKBNEW_GAMEOVER",	 -- 结束
        GAME_PLAYER_OPEN                  = "OXQKBNEW_PLAYER_OPEN ",   --所有玩家卡牌数据
