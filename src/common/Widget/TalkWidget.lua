...
local  TalkUITag = {
		...
		checkBoxFace = 57,
		checkBoxlanguage = 58,
		language = {{tag = 1, text = "封牌"},{tag = 2, text = "看什么看呢，快点出牌~"},{tag = 3, text = "胡乱出牌"},
					{tag = 4 ,text = "急什么，让我想想怎么打"},{tag =5,text ="输光了~" },{tag = 6,text = "你的牌打得也太好了"},
					{tag = 7,text ="好差的牌"},{tag = 8,text = "这牌太差了"},{tag = 9,text = "手气怎么这么差"},
					{tag = 10,text = "这局要赢定了"},{tag = 11,text = "这局要输惨了"},{tag = 12,text = "哎呀，点错了"},{tag = 13,text = "不好意思，出错牌了"},
					{tag = 14,text = "什么烂牌啊，没法跟你们决战了！"},{tag = 15,text = "这个牌你都够胆打"},{tag = 16,text = "哇，这么久的，宵夜都吃完了"},
					{tag = 17,text = "不要走，再来一局"},
					{tag = 18,text = "你出的什么牌啊！比皇帝还大！"},{tag = 19,text = "我唔怕你银纸多"},
					{tag = 20,text = "大旺狗无甘串 风鼠轮流转"},{tag = 21,text = "过，放你都唔生"},
					{tag = 22,text = "挂咯，甘衰哦牌"},},
		face = {{tag = 23, img = "chat_1.png"},{tag = 24,img = "chat_2.png"},{tag = 25,img = "chat_3.png"},
				{tag = 26,img = "chat_4.png"},{tag = 27,img = "chat_5.png"},{tag = 28,img = "chat_6.png"},
				{tag = 29,img = "chat_7.png"},{tag = 30,img = "chat_8.png"},},
...
function TalkWidget:ctor( serviceClient )
	--加载JSON
    self.mainWidget = GameUtil:widgetFromCocostudioFile("ys9zhang/talkWidget"):addTo(self)
