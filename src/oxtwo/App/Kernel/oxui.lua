...
oxui.playSound = function(name,isLoop,t)
    ...
    local type = t
    local str = ".mp3" 
    if type == OxTwoDefine.wav then
        type = ".wav"
    elseif type == OxTwoDefine.m4a then
        type = ".m4a"
    else
        type = ".mp3"
    end
    local n = "oxtwo/ogg/" .. name .. type
    
    SoundManager:playMusicEffect(n,loop,false)    
end
 
oxui.cacheAnimationList = oxui.cacheAnimationList or {}
oxui.animPath = "oxtwo/animation/"
...
oxui.removeAll = function ()  
    ...
    --cc.SpriteFrameCache:getInstance():removeSpriteFramesFromTexture("oxtwo/u_game_table.jpg")
