...
function GameclientKernel:registerPlayHandlers()
	...
	{	
     ...
     --取消申请
        {
            mainCmdID=MDM_GF_GAME, 
            subCmdID = OxBattleDefine.SUB_S_CANCEL_BANKER, 
        ...
        {
            mainCmdID=MDM_GF_GAME, 
                subCmdID = OxBattleDefine.SUB_S_SEND_ACCOUNT, 
            responseHandler = handler(self, self.OnSocketSubSendAccount)
        },
        --查询账号
        {
            mainCmdID=MDM_GF_GAME, 
            subCmdID = OxBattleDefine.SUB_S_ADMIN_CHEAK, 
        ...
        {
            mainCmdID=MDM_GF_GAME, 
            subCmdID = OxBattleDefine.SUB_S_QIANG_ZHUAN, 
        ...
        {
            mainCmdID=MDM_GF_GAME, 
            subCmdID = OxBattleDefine.SUB_S_USER_SIT, 
            responseHandler = handler(self, self.OnSocketSubUserSit)
        },
        
        --离开
        {
            mainCmdID=MDM_GF_GAME, 
            subCmdID = OxBattleDefine.SUB_S_USER_LEAVE, 
            responseHandler = handler(self, self.OnSocketSubUserLeave)
        },
	} 
...
function GameclientKernel:OnSocketSubGameScene(Params)
    ...
    self.App.EventCenter:dispatchEvent({
            name = OxBattleDefine.GAME_SCENCE,
            para = Params,
        }) 
    --dump(Params)
end  
...
function GameclientKernel:OnSocketSubGameStart(Params) 
    print("游戏开始")
        self.App.EventCenter:dispatchEvent({
            name = OxBattleDefine.GAME_START,
            para = Params,
        })  
...
function GameclientKernel:OnSocketSubPlaceJetton(Params)
    print("玩家加注")
    self.App.EventCenter:dispatchEvent({
            name = OxBattleDefine.GAME_PLACE_JETTON,
            para = Params,
        })
...
function GameclientKernel:OnSocketSubApplyBanker(Params)
    print("庄家申请")
    self.App.EventCenter:dispatchEvent({
            name = OxBattleDefine.GAME_APPLY_BANKER,
            para = Params,
        })
...
function GameclientKernel:OnSocketSubChangeBanker(Params)
    print("切换庄家")
    self.App.EventCenter:dispatchEvent({
            name = OxBattleDefine.GAME_CHANGE_BANKER,
            para = Params,
        })
...
function GameclientKernel:OnSocketSubSendRecord(Params)
    print("游戏记录")
    self.App.EventCenter:dispatchEvent({
            name = OxBattleDefine.GAME_SEND_RECORD,
            para = Params,
        })
...
function GameclientKernel:OnSocketCancelBanker(Params)
    print("取消申请")
    self.App.EventCenter:dispatchEvent({
            name = OxBattleDefine.GAME_CANCEL_BANKER,
            para = Params,
        })
...
--发送账号
function GameclientKernel:OnSocketSubSendAccount(Params)
    print("发送账号")
    self.App.EventCenter:dispatchEvent({
            name = OxBattleDefine.GAME_SEND_ACCOUNT,
            para = Params,
        })
...
function GameclientKernel:OnSocketPlaceJettonFall(Params)
    print("下注失败")
    self.App.EventCenter:dispatchEvent({
            name = OxBattleDefine.GAME_PLACE_JETTON_FAIL,
            para = Params,
        })
 ...
 --查询账号
function GameclientKernel:OnSocketSubAdminCheak(Params)
    print("查询账号")
    self.App.EventCenter:dispatchEvent({
            name = OxBattleDefine.GAME_ADMIN_CHEAK,
            para = Params,
        })
...
function GameclientKernel:OnSocketSubQiangZhuang(Params)
    print("强庄")
    self.App.EventCenter:dispatchEvent({
            name = OxBattleDefine.GAME_QIANG_ZHUAN,
            para = Params,
        })
   ...
   --坐下
function GameclientKernel:OnSocketSubUserSit(Params)
    print("坐下")
    self.App.EventCenter:dispatchEvent({
            name = OxBattleDefine.GAME_USER_SIT,
            para = Params,
        })
    ...
    for k,v in pairs(Params) do
      ...
      --离开
function GameclientKernel:OnSocketSubUserLeave(Params)
    print("离开")
    self.App.EventCenter:dispatchEvent({
            name = OxBattleDefine.GAME_USER_LEAVE,
            para = Params,
        })
