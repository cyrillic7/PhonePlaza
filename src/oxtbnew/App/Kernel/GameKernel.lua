...
function GameclientKernel:registerPlayHandlers()
	...
	{	
     ...
     --发牌
        {
            mainCmdID=MDM_GF_GAME, 
            subCmdID = OxtbNewDefine.SUB_S_SEND_CARD, 
        ...
        {
            mainCmdID=MDM_GF_GAME, 
                subCmdID = OxtbNewDefine.SUB_S_CHANGE_OPEN, 
...
function GameclientKernel:OnSocketSubPlayerOpen(Params)
    self.App.EventCenter:dispatchEvent({
        name = OxtbNewDefine.GAME_PLAYER_OPEN,
        para = Params,
    }) 
    --dump(Params)
end  
...
function GameclientKernel:OnSocketSubGameScene(Params)
    self.App.EventCenter:dispatchEvent({
            name = OxtbNewDefine.GAME_SCENCE,
            para = Params,
        }) 
    --dump(Params)
end  
...
function GameclientKernel:OnSocketSubGameAddScore(Params)
     self.App.EventCenter:dispatchEvent({
            name = OxtbNewDefine.GAME_ADD_SCORE,
            para = Params,
        })
...
function GameclientKernel:OnSocketSubPlayerExit(Params)
    --print("玩家强制退出Socket")
    self.App.EventCenter:dispatchEvent({
            name = OxtbNewDefine.GAME_PLAYER_EXIT,
            para = Params,
        })
...
function GameclientKernel:OnSocketSubChangeOpen(Params)
    print("摊牌Socket")
    self.App.EventCenter:dispatchEvent({
            name = OxtbNewDefine.GAME_CHANGE_OPEN,
            para = Params,
        }) 
    for k,v in pairs(Params) do
        print(k,v)
...
function GameclientKernel:OnSocketSubOpenCard(Params)
    print("开牌Socket")
    self.App.EventCenter:dispatchEvent({
        name = OxtbNewDefine.GAME_OPEN_CARD,
            para = Params,
        })
...
function GameclientKernel:OnSocketSubChangeCard(Params)
    --print("换牌Socket")
    self.App.EventCenter:dispatchEvent({
            name = OxtbNewDefine.GAME_CHANGE_CARD,
            para = Params,
        })
...
function GameclientKernel:OnSocketSubCallBanker(Params)
    --print("叫庄Socket")
    self.App.EventCenter:dispatchEvent({
            name = OxtbNewDefine.GAME_CALL_BANKER,
            para = Params,
        })
...
function GameclientKernel:OnSocketSendCard(Params)
    --print("发牌Socket")
    self.App.EventCenter:dispatchEvent({
            name = OxtbNewDefine.GAME_SEND_CARD,
            para = Params,
        })
