...
oxui.playSound = function(name,isLoop,t)
    ...
    local type = t
    local str = ".mp3" 
    if type == OxqkbnewDefine.wav then
        type = ".wav"
    elseif type == OxqkbnewDefine.m4a then
        type = ".m4a"
    else
        type = ".mp3"
    end
    local n = "oxqkbnew/ogg/" .. name .. type
    
    SoundManager:playMusicEffect(n,loop,false)    
end
 
oxui.cacheAnimationList = oxui.cacheAnimationList or {}
oxui.animPath = "oxqkbnew/animation/"
...
oxui.removeAll = function ()  
    ...
    --cc.SpriteFrameCache:getInstance():removeSpriteFramesFromTexture("oxqkbnew/u_game_table.jpg")
